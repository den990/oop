...
bool Car::SetGear(int gear)
{
	...
	case 4:
		[[fallthrough]];
	case 5:
		if (!CheckSpeedRange(m_speed, gear)) /* (m_speed < gearSpeedRange.at(gear).first || gearSpeedRange.at(gear).second < m_speed)*/
		{
...
bool Car::SetSpeed(int speed)
{
	...
	case 4:
		[[fallthrough]];
	case 5:
		if (!CheckSpeedRange(speed, m_gear)) /* (speed < gearSpeedRange.at(m_gear).first || gearSpeedRange.at(m_gear).second < speed) //записать один раз*/
		{
